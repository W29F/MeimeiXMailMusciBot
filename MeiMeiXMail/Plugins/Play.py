...
from MeiMeiXMail import (BOT_USERNAME, DURATION_LIMIT, DURATION_LIMIT_MIN,
                   MUSIC_BOT_NAME, app, db_mem)
from MeiMeiXMail.Core.PyTgCalls.Converter import convert
from MeiMeiXMail.Core.PyTgCalls.Downloader import download
from MeiMeiXMail.Decorators.assistant import AssistantAdd
from MeiMeiXMail.Decorators.checker import checker
from MeiMeiXMail.Decorators.permission import PermissionCheck
from MeiMeiXMail.Inline import (playlist_markup, search_markup, search_markup2,
                          url_markup, url_markup2)
from MeiMeiXMail.Utilities.changers import seconds_to_min, time_to_seconds
from MeiMeiXMail.Utilities.chat import specialfont_to_normal
from MeiMeiXMail.Utilities.stream import start_stream, start_stream_audio
from MeiMeiXMail.Utilities.theme import check_theme
from MeiMeiXMail.Utilities.thumbnails import gen_thumb
from MeiMeiXMail.Utilities.url import get_url
from MeiMeiXMail.Utilities.youtube import (get_yt_info_id, get_yt_info_query,
...
@app.on_callback_query(filters.regex(pattern=r"MeiMei"))
