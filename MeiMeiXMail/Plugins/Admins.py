...
from MeiMeiXMail.Database import (is_active_chat, is_music_playing, music_off,
                            music_on, remove_active_chat)
from MeiMeiXMail.Decorators.admins import AdminRightsCheck
from MeiMeiXMail.Decorators.checker import checker, checkerCB
from MeiMeiXMail.Inline import audio_markup, primary_markup
...
async def admins(_, message: Message):
    ...
    if message.command[0][1] == "e":
        ...
        await MeimeiXMail.pytgcalls.resume_stream(message.chat.id)
        await message.reply_text(
    ...
    if message.command[0][1] == "t" or message.command[0][1] == "n":
        ...
        await MeimeiXMail.pytgcalls.leave_group_call(message.chat.id)
        await message.reply_text(
