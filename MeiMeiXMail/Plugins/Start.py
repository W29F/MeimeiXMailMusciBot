...
from MeiMeiXMail import ASSID, BOT_ID, MUSIC_BOT_NAME, OWNER_ID, SUDOERS, app
from MeiMeiXMail import boottime as bot_start_time
from MeiMeiXMail import db
from MeiMeiXMail.Core.PyTgCalls import MeimeiXMail
from MeiMeiXMail.Database import (add_nonadmin_chat, add_served_chat,
...
from MeiMeiXMail.Decorators.admins import ActualAdminCB
from MeiMeiXMail.Decorators.permission import PermissionCheck
from MeiMeiXMail.Inline import (custommarkup, dashmarkup, setting_markup, setting_markup2,
                          start_pannel, usermarkup, volmarkup)
from MeiMeiXMail.Utilities.ping import get_readable_time
...
async def start_markup_check(_, CallbackQuery):
    ...
    if command == "LV":
        ...
        volume = 25
        try:
            await MeimeiXMail.pytgcalls.change_volume_call(c_id, volume)
    ...
    if command == "DIT":
        ...
        await CallbackQuery.answer(
            f"MeiMeiXMail Disk Usage: {diske}%", show_alert=True
        )
