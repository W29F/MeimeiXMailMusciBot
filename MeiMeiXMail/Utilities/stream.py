...
from MeiMeiXMail import BOT_USERNAME, db_mem
from MeiMeiXMail.Core.PyTgCalls import MeimeiXMail, Queues
from MeiMeiXMail.Database import (add_active_chat, is_active_chat, music_off,
                            music_on)
from MeiMeiXMail.Inline import (audio_markup, audio_markup2, primary_markup,
                          secondary_markup)
