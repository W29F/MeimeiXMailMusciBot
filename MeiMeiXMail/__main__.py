...
from MeiMeiXMail import (ASSID, ASSMENTION, ASSNAME, ASSUSERNAME, BOT_ID, BOT_NAME,
                   BOT_USERNAME, SUDOERS, app, db, userbot)
from MeiMeiXMail.Core.Logger.Log import (startup_delete_last, startup_edit_last,
                                   startup_send_new)
from MeiMeiXMail.Core.PyTgCalls.MeimeiXMail import run
from MeiMeiXMail.Database import get_active_chats, get_sudoers, remove_active_chat
from MeiMeiXMail.Inline import private_panel
from MeiMeiXMail.Plugins import ALL_MODULES
from MeiMeiXMail.Utilities.inline import paginate_modules
...
async def initiate_bot():
    with console.status(
        "[magenta] Booting up The MeiMei Music Bot...",
    ) as status:
    ...
    console.print(
        "[bold green]Congrats!! MeiMei Music Bot has started successfully!\n"
    )
    try:
    ...
    try:
        ...
        return
    try:
        await userbot.join_chat("mailmusicupdate")
    except:
        pass
